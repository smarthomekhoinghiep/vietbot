...
def kiemtra_amlich(list):
    ...
    if ss == 15:
        speaking.speak(a+" âm lịch là rằm "+ thang_am1 + 'năm ' + can[vitri_can] +' '+ chi[vitri_chi]+' ' + nam_am)
    elif ss == 1:
        speaking.speak(a+" âm lịch là mùng một "+ thang_am1 + 'năm ' + can[vitri_can] +' '+ chi[vitri_chi]+ ' ' + nam_am)
    elif ss>1 and ss<15:
        days_left = 15 - ss
        speaking.speak(a+" âm lịch là " + ngay_am +' '+ thang_am1 + ' năm ' + can[vitri_can] +' '+ chi[vitri_chi] +' '+ nam_am + ". Còn " + str(days_left) + " ngày nữa là đến rằm")
